...
T["format_date()"]["today's date is formatted as HH:MM"] = function()
  ...
  MiniTest.expect.equality(result, "14:30")
end

T["format_date()"]["other dates are formatted as YYYY-MM-DD HH:MM"] = function()
  -- Use a fixed past date
  local iso_date = "2020-06-15T22:18:30.000Z"

  local result = stash.format_date(iso_date)

  MiniTest.expect.equality(result, "2020-06-15 22:18")
end
